...
public class LecturaDeArchivo {
    public static File Constructor_1(){
        ...
        File fichero = new File("recursos/ArchivoRecursos.txt"); //=>> "Fichero.txt se llama RUTA RELATIVA"
    ...
    public static File Constructor_2(){
        ...
        File fichero = new File("recursos","ArchivoRecursos.txt");//=>> idica ruta, indca nombre del archivo.
    ...
    public static File Constructor_3(){
        ...
        File ruta = new File("recursos");
        File fichero = new File(ruta,"ArchivoRecursos.txt");
        //En este caso se indica la ruta relativa tomando como base el directorio actual de trabajo.
        //MOSTRAR EJEMPLO DE RUTA ABSOLUTA
        return fichero;
    }
